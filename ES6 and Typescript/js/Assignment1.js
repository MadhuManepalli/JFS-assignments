...
userFriends("Madhu", "dhanu", "eswar", "nutan", "naidu", "manas");
//  //ans C.
function printCapitalNames(name1, name2, name3, name4, name5, name6) {
    console.log("Names after");
    console.log(name1.toUpperCase() + " " + name2.toUpperCase() + " " + name3.toUpperCase() + " " + name4.toUpperCase() + " " + name5.toUpperCase() + " " + name6.toUpperCase());
}
var nameList = ["Madhu", "dhanu", "eswar", "nutan", "naidu", "manas"];
...
//  */
let laptopModel = "ASUS TUF gaming FX504 series";
let deskNo = 5010;
let name = "Madhu";
console.log(`TICKET:
...
//  */
// ans a.
var names = ["PUBG", "APEXLEGENDS", "BGMI", "GTAV"];
...
var SavingAccountObj = new SavingAccount(1, "Dhanu", 6000, 5);
console.log(SavingAccountObj.getBalance());
var SavingAccountObj = new SavingAccount(2, "Madhu", 8000, 10);
console.log(SavingAccountObj.getBalance());
var CurrentAccountObj = new CurrentAccount(20, "Eswar", 2000, 100);
console.log(CurrentAccountObj.getBalance());
var CurrentAccountObj = new CurrentAccount(5, "nutan", 50000, 100);
console.log(CurrentAccountObj.getBalance());
